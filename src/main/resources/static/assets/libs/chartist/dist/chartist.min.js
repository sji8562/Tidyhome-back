...
!function (a, b) {
    ...
    return function (a, b, c) {
        ...
        c.namespaces = {
            ...
            return f.normalized.series = c.getDataArray({series: a.series || []}, b, d), e = f.normalized.series.every(function (a) {
            ...
            var g, h, i, j = 0, k = {high: b.high, low: b.low};
            ...
            var l = c.projectLength(a, k.step, k), m = l < d, n = e ? c.rho(k.range) : 0;
        ...
        function d(a) {
            ...
            k = a.distributeSeries && a.stackBars ? b.normalized.labels.slice(0, 1) : b.normalized.labels, a.horizontalBars ? (j = m = void 0 === a.axisX.type ? new c.AutoScaleAxis(c.Axis.units.x, b.normalized.series, o, c.extend({}, a.axisX, {
                ...
                highLow: d,
                referenceValue: 0
            })), l = n = void 0 === a.axisY.type ? new c.StepAxis(c.Axis.units.y, b.normalized.series, o, {ticks: k}) : a.axisY.type.call(c, c.Axis.units.y, b.normalized.series, o, a.axisY)) : (l = m = void 0 === a.axisX.type ? new c.StepAxis(c.Axis.units.x, b.normalized.series, o, {ticks: k}) : a.axisX.type.call(c, c.Axis.units.x, b.normalized.series, o, a.axisX), j = n = void 0 === a.axisY.type ? new c.AutoScaleAxis(c.Axis.units.y, b.normalized.series, o, c.extend({}, a.axisY, {
                highLow: d,
                referenceValue: 0
        ...
        function e(a) {
            var b, e, f, h, i, j = c.normalizeData(this.data), k = [], l = a.startAngle;
            ...
            j.raw.series.forEach(function (a, b) {
                ...
                if (0 !== j.normalized.series[g] || !a.ignoreEmptyValues) {
                    ...
                    var r, s, t, u = c.polarToCartesian(n.x, n.y, f, q), v = c.polarToCartesian(n.x, n.y, f, p),
